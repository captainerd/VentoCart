  ...
  foreach ($groupedarticles as $monthYear => $monthArticles):
    ...
    <div class="list-group mb-3">
      ...
      <?php foreach ($monthArticles as $article): ?>
        <a href="<?= $article['href'] ?>"
          class="list-group-item list-group-item-action<?= $article['article_id'] == $article_id ? ' active' : '' ?>">
          <div class="d-flex justify-content-between align-items-center">
...
<div class="list-group mb-3">
  ...
  <div class="list-group mb-3">
    <?php foreach ($topics as $topic): ?>
      <a href="<?= $topic['href'] ?>"
        class="list-group-item list-group-item-action<?= $topic['topic_id'] == $topic_id ? ' active' : '' ?>">
        <div class="d-flex justify-content-between align-items-center">
