  ...
  <div class="row"><?= $column_left ?>
    <div id="content" class="col"><?= $content_top ?>
      ...
      <table class="table table-bordered table-hover">
        ...
        <tbody>
          <tr>
            <td class="text-start" style="width: 50%;"><b><?= $this->e($text_return_id) ?></b>
              #<?= $this->e($return_id) ?>
              <br />
              <b><?= $this->e($text_date_added) ?></b> <?= $this->e($date_added) ?>
            </td>
            <td class="text-start" style="width: 50%;"><b><?= $this->e($text_orders_id) ?></b>
              #<?= $this->e($order_id) ?>
              <br />
              <b><?= $this->e($text_date_ordered) ?></b> <?= $this->e($date_ordered) ?>
            </td>
          </tr>
        </tbody>
      </table>
        ...
        <table class="table table-bordered table-hover">
          <thead>
            <tr>
              ...
              <td class="text-start" style="width: 33.3%;"><?= $this->e($column_sku) ?></td>
