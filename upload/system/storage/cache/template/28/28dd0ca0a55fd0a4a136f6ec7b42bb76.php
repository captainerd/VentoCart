...
/* cp-akis/view/default/plates/common/language.twig */
class __TwigTemplate_d8536af4a161958a6f0676e8a0621848 extends Template
{
    private $source;
    private $macros = [];
...
\$('#nav-language .dropdown-item').on('click', function (e) {
    ...
    \$.ajax({
        ...
        success: function (json) {
            //x console.log(\$(element).attr('href'));
            //x console.log(\$('input-redirect').val());
...
//--></script>";
    ...
    {
        return "cp-akis/view/default/plates/common/language.twig";
    }
...
//--></script>", "cp-akis/view/default/plates/common/language.twig", "/home/natsos/web/ventocart.lan/public_html/cp-akis/view/default/plates/common/language.twig");
    }
}
