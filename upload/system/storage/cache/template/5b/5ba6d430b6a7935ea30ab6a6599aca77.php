...
/* cp-akis/view/default/plates/extension/ventocart/dashboard/chart_info.twig */
class __TwigTemplate_d30233674ad633b03fc464fd9d6d94c0 extends Template
{
    private $source;
    private $macros = [];
...
\$('#range a').on('click', function (e) {
    ...
    \$.ajax({
        type: 'get',
        url: 'index.php?route=extension/ventocart/dashboard/chart.chart&user_token=";
        // line 26
...
";
    ...
    {
        return "cp-akis/view/default/plates/extension/ventocart/dashboard/chart_info.twig";
    }
...
\$('#range a').on('click', function (e) {
    ...
    \$.ajax({
        type: 'get',
        url: 'index.php?route=extension/ventocart/dashboard/chart.chart&user_token={{ user_token }}&range=' + \$(this).attr('href'),
        dataType: 'json',
        success: function (json) {
            if (typeof json['order'] == 'undefined') {
                return false;
...
\$('#range a.active').trigger('click');
//--></script>
", "cp-akis/view/default/plates/extension/ventocart/dashboard/chart_info.twig", "/home/natsos/web/ventocart.lan/public_html/cp-akis/view/default/plates/extension/ventocart/dashboard/chart_info.twig");
    }
}
