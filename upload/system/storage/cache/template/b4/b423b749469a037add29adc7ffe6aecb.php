...
/* cp-akis/view/default/plates/extension/ventocart/dashboard/map_info.twig */
class __TwigTemplate_34cc7d8dfdd0dcace73f2857be6f3e93 extends Template
{
    private $source;
    private $macros = [];
...
\$(document).ready(function () {
    \$.ajax({
        url: 'index.php?route=extension/ventocart/dashboard/map.map&user_token=";
        // line 13
...
";
    ...
    {
        return "cp-akis/view/default/plates/extension/ventocart/dashboard/map_info.twig";
    }
...
\$(document).ready(function () {
    \$.ajax({
        url: 'index.php?route=extension/ventocart/dashboard/map.map&user_token={{ user_token }}',
        dataType: 'json',
        success: function (json) {
            data = [];
...
//--></script>
", "cp-akis/view/default/plates/extension/ventocart/dashboard/map_info.twig", "/home/natsos/web/ventocart.lan/public_html/cp-akis/view/default/plates/extension/ventocart/dashboard/map_info.twig");
    }
}
