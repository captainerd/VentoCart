...
class __TwigTemplate_6123759b67bee7567670dd592b3b21d7 extends Template
{
    private $source;
    private $macros = [];
      ...
      ";
        ...
        <ul class=\"nav navbar-nav\">
          ...
          <li id=\"nav-profile\" class=\"nav-item dropdown\">
            ...
            echo "</h6></li>
              <li><a href=\"https://www.ventocart.com\" target=\"_blank\" class=\"dropdown-item\"><i class=\"fa-brands fa-opencart fa-fw\"></i> ";
            // line 84
        ...
        <ul class=\"nav navbar-nav\">
          ...
          <li id=\"nav-profile\" class=\"nav-item dropdown\">
            ...
            <ul class=\"dropdown-menu dropdown-menu-end\">
              ...
              <li><a href=\"https://www.ventocart.com\" target=\"_blank\" class=\"dropdown-item\"><i class=\"fa-brands fa-opencart fa-fw\"></i> {{ text_homepage }}</a></li>
...
</script>", "admin/view/template/common/header.twig", "/var/www/html/admin/view/template/common/header.twig");
    }
}
