...
/* cp-akis/view/template/common/header.twig */
class __TwigTemplate_34ffdab2d01816f79d6d4f693799c222 extends Template
{
    private $source;
    private $macros = [];
...
\$(\"#security_modal\").on('click', function() {
  ...
  \$(document).ready(function() {
    ...
    {
        return "cp-akis/view/template/common/header.twig";
    }
...
</script>", "cp-akis/view/template/common/header.twig", "/home/natsos/web/ventocart.lan/public_html/cp-akis/view/template/common/header.twig");
    }
}
