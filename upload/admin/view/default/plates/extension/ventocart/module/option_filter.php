					...
					<div class="row mb-3">
						...
						<div class="col-sm-10">
							<div class="form-check form-switch form-switch-lg">
								...
								<input type="checkbox" name="module_option_filter_status" value="1" id="input-status" class="form-check-input" <?php if (!empty($module_option_filter_status)) { ?>checked<?php } ?>/>
							</div>
						</div>
					</div>
				</form>
