...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="float-end">
                <button type="submit" form="form-shipping" data-bs-toggle="tooltip" title="<?= $button_save ?>"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-check form-switch form-switch-lg">
                                ...
                                <input type="checkbox" name="shipping_zoneshipping_status" value="1" id="input-status"
                                    class="form-check-input" <?= $status ? 'checked' : '' ?> />
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="shipping_zoneshipping_sort_order"
                                value="<?= $shipping_zoneshipping_sort_order ?>" placeholder="<?= $entry_sort_order ?>"
                    ...
                    <div>
                        ...
                        <div class="mb-3 row">
                            <label for="input-filter-company"
                                class="col-sm-2 col-form-label"><?= $entry_filter_shipping_company ?>
                            </label>
                            <div class="col-sm-10">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <button id="add-new-entry-f" type="button"
                                    class="btn mt-3 btn-primary"><?= $entry_addnew ?></button>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-sm-10">
                                                <?php foreach ($languages as $language): ?>
                                                    <div class="input-group">
                                                        <div class="input-group-text"><img src="<?= $language['image'] ?>"
                                                                title="<?= $language['name'] ?>" /></div>
                                                        <input list="allnames" type="text"
                                                            name="displayName[<?= $language['language_id'] ?>]"
                                                            id="input-display-name" class="form-control" />
                                                    </div>
                                                <?php endforeach; ?>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-10">
                                                <select name="geo_zone_id" id="input-country" class="form-select">
                                                    ...
                                                    <?php foreach ($geoZones as $geoZone): ?>
                                                        ...
                                                        <option value="<?= $geoZone['geo_zone_id'] ?>">
                                                            <?= $geoZone['name'] ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                </select>
                                                <div class="form-text">
                                                    <a
                                                        href="index.php?route=localisation/geo_zone&user_token=<?= $user_token ?>"><?= $geo_zones_help ?></a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            <label for="input-price"
                                                class="col-sm-2 col-form-label"><?= $entry_add_to_pricelist ?>:</label>
                                            <div class="col-sm-10">
                                                <div class="row">
                                                    <div class="col  p-0 ">
                                                    ...
                                                    <div class="col  p-0 ">
                                                        <input type="text" name="default_price" id="input-default_price"
                                                            class="form-control"
                                                            placeholder="<?= $entry_default_price ?>" />
                                                    ...
                                                    <div class="col  p-0 ">
                                                        <div class="input-group">
                                                            ...
                                                            <button type="button" id="btn-add-pricelist"
                                                                class="btn btn-primary">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="weight_class_id" id="input-weight-class"
                                                    ...
                                                    <?php foreach ($weight_classes as $weight_class): ?>
                                                        <option <?php if ($default_weigth == $weight_class['weight_class_id']): ?> selected
                                                            <?php endif; ?> value="<?= $weight_class['weight_class_id'] ?>">
                                                            <?= $weight_class['title'] ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                </select>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="volumetric" value="5" id="input-volumetric"
                                                    class="form-control">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="input-postal-codes"
                                                class="col-sm-2 col-form-label"><?= $entry_postal_codes ?></label>
                                            <div class="spinner-border text-primary" style="display:none"
                                                id="loading-postalcode" role="status">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="entry_sort_order"
                                                    value="<?= $shipping_zoneshipping_sort_order ?>"
                                                    placeholder="<?= $entry_sort_order ?>" id="input-entry-sort-order"
                                                    class="form-control" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <button id="deleteentry"
                                                    class="btn btn-danger"><?= $button_delete ?></button>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel"><?= $text_edit_price ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label for="editWeight" class="form-label"><?= $entry_weight ?></label>
                ...
                <div class="mb-3">
                    <label for="editDefaultPrice" class="form-label"><?= $entry_default_price ?></label>
                    <input type="text" class="form-control" id="editDefaultPrice" />
                </div>
                <div class="mb-3">
                    <label for="editPrice" class="form-label"><?= $entry_price ?></label>
                    <input type="text" class="form-control" id="editPrice" />
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?= $button_cancel ?></button>
                <button type="button" id="saveEditBtn" class="btn btn-primary"><?= $button_save ?></button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        ...
        $('#input-default_price').on('change', function () {
            // Get the value of the default price input
            const defaultPriceValue = $(this).val();

            // Check if the price input is empty
            if ($('#input-price').val().trim() === '') {
                // Set the price input to the same value as default price
                $('#input-price').val(defaultPriceValue);
            }
        });
        ...
        function populatePriceList(priceList) {
            ...
            priceList.forEach(function (price, index) {
                var display = $('<div>').addClass('mb-2 p-1 hover-effect  border-bottom');
                ...
                var deleteBtn = $('<a>')
                    ...
                    .click(function () {
                        if (confirm("Are you sure you want to delete this entry?")) {
                            // Remove the price at the specific index
                ...
                var editBtn = $('<a>')
                    ...
                    .click(function () {
                        // Populate modal fields with current price values
                        $('#editModal').data('index', index); // Store index in the modal
                        $('#editWeight').val(price.weight);
                        $('#editDefaultPrice').val(price.default_price);
                        $('#editPrice').val(price.price);
                        // Show the modal
                        $('#editModal').modal('show');
                    });

                // Create a row to hold price details, delete button, and edit button
                var row = $('<div>').addClass('row');
                var buttonContainer = $('<div>').addClass('d-flex gap-1'); // Use Flexbox for alignment and spacing
                ...
                row.append(
                    ...
                    $('<div class="col-md-1"></div>').append(buttonContainer)
                );
            ...
            // Update hidden input with current JSON state
            $('#pricelist-input').val(JSON.stringify(priceList));
        }
        ...
        $('#saveEditBtn').click(function () {
            ...
            var index = $('#editModal').data('index'); // Retrieve the index from the modal
            var priceList = JSON.parse($('#pricelist-input').val());

            if (index !== undefined) {
                // Update the price object with new values
                priceList[index] = {
                    weight: $('#editWeight').val(),
                    default_price: $('#editDefaultPrice').val(),
                    price: $('#editPrice').val(),
                };
                // Update hidden input with updated JSON data
                $('#pricelist-input').val(JSON.stringify(priceList));
