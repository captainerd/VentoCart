<?php
namespace Ventocart\Admin\Controller\Extension\Ventocart\Currency;
/**
 * Class Fixer
 *
 * @package Ventocart\Admin\Controller\Extension\Ventocart\Currency
 */
class Fixer extends \Ventocart\System\Engine\Controller {
	/**
	 * @return void
	 */
	public function index(): void {
		$this->load->language('extension/ventocart/currency/fixer');
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/ventocart/currency/fixer', 'user_token=' . $this->session->data['user_token'])
		];

		$data['save'] = $this->url->link('extension/ventocart/currency/fixer.save', 'user_token=' . $this->session->data['user_token']);
		...
		$this->response->setOutput($this->load->view('extension/ventocart/currency/fixer', $data));
	}
	...
	public function save(): void {
		...
		if (!$this->user->hasPermission('modify', 'extension/ventocart/currency/fixer')) {
