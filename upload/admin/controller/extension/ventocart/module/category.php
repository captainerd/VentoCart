...
class Category extends \Ventocart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['save'] = $this->url->link('extension/ventocart/module/category.save', 'user_token=' . $this->session->data['user_token']);
		...
		$this->response->setOutput($this->load->view('extension/ventocart/module/category', $data));
	}
