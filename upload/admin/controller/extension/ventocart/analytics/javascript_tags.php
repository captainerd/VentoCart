...
class JavaScriptTags extends \Ventocart\System\Engine\Controller
{
	...
	public function index(): void
	{
		...
		$data['store_tag'] = $this->model_setting_setting->getValue('analytics_javascript_tags_tag');
		...
		$data['status'] = $this->model_setting_setting->getValue('analytics_javascript_tags_status');
	...
	public function save(): void
	{
		...
		if (!$json) {
			...
			$this->model_setting_setting->editSetting('analytics_javascript_tags', $this->request->post);
