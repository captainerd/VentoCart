...
$_['entry_tax'] = 'Display Main Prices With Tax';
$_['entry_tax_display_without_tax'] = 'Display Prices Excluding Tax';
$_['entry_tax_display_amount_tax'] = 'Display Tax Amount (Included in Price)';
...
$_['entry_config_show_company_field'] = 'Display company field';
...
$_['entry_minify_all'] = 'Minify theme assets';
...
$_['help_processing_status'] = 'Set the order status the customer\'s order must reach before the order starts stock subtraction and coupon and rewards redemption.';
$_['help_complete_status'] = 'Set the order status the customer\'s order must reach before they are allowed to access their downloadable products.';
$_['help_fraud_status'] = 'Set the order status when a customer is suspected of trying to alter the order payment details or use a coupon, gift  or reward points that have already been used.';
$_['help_subscription'] = 'Set the default subscription status when a customer is suspected of trying to alter the order payment details or use a coupon or reward points that have already been used.';
...
$_['help_minify_all'] = 'When enabled, all CSS and JS assets found in /view dirs will be replaced with their minified versions, disabling restores the original assets.';
