...
class PayPalPayLater extends \Ventocart\System\Engine\Controller {
	private $error = [];
	private $separator = '';
	...
	public function index(): string {
		...
		if ($this->config->get('payment_paypal_status') && $this->config->get('payment_paypal_client_id') && $this->config->get('payment_paypal_secret') && $agree_status) {
			...
			return $this->load->view('extension/paypal/payment/paypal_paylater', $data);
		}
	...
	public function modal(): void {
		...
		$this->response->setOutput($this->load->view('extension/paypal/payment/paypal_paylater_modal', $data));
	}
}