...
class PayPalGooglePay extends \Ventocart\System\Engine\Controller {
	...
	public function index(): string {
		...
		if ($this->config->get('payment_paypal_status') && $this->config->get('payment_paypal_client_id') && $this->config->get('payment_paypal_secret') && $agree_status) {
			...
			return $this->load->view('extension/paypal/payment/paypal_googlepay', $data);
		}
	...
	public function modal(): void {
		...
		$this->response->setOutput($this->load->view('extension/paypal/payment/paypal_googlepay_modal', $data));
	}
}