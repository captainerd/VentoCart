<?php
namespace Ventocart\Admin\Model\Extension\Ventocart\Other;
/**
 * Class Cloud
 *
 * @package Ventocart\Admin\Model\Extension\Ventocart\Other
 */
class Cloud extends \Ventocart\System\Engine\Model {
	/**
	 * @return void
	 */
