...
class Customer extends \Ventocart\System\Engine\Controller {
	...
	public function index(): void {
		$this->load->language('extension/ventocart/dashboard/customer');
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/ventocart/dashboard/customer', 'user_token=' . $this->session->data['user_token'])
		];

		$data['save'] = $this->url->link('extension/ventocart/dashboard/customer.save', 'user_token=' . $this->session->data['user_token']);
		...
		$this->response->setOutput($this->load->view('extension/ventocart/dashboard/customer_form', $data));
	}
	...
	public function save(): void {
		...
		if (!$this->user->hasPermission('modify', 'extension/ventocart/dashboard/customer')) {
	...
	public function dashboard(): string {
		...
		return $this->load->view('extension/ventocart/dashboard/customer_info', $data);
	}
}
