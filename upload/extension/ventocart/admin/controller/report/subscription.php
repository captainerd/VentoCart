...
class Subscription extends \Ventocart\System\Engine\Controller {
    ...
    public function index(): void {
        $this->load->language('extension/ventocart/report/subscription');
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('extension/ventocart/report/subscription', 'user_token=' . $this->session->data['user_token'])
        ];
        
        $data['save'] = $this->url->link('extension/ventocart/report/subscription.save', 'user_token=' . $this->session->data['user_token']);
        ...
        $this->response->setOutput($this->load->view('extension/ventocart/report/subscription_form', $data));
    }
    ...
    public function save(): void {
        ...
        if (!$this->user->hasPermission('modify', 'extension/ventocart/report/subscription')) {
    ...
    public function report(): void {
        ...
        $this->response->setOutput($this->load->view('extension/ventocart/report/subscription', $data));
    }
    ...
    public function getReport(): string {
        ...
        $this->load->model('extension/ventocart/report/subscription');
        
        $subscription_total = $this->model_extension_ventocart_report_subscription->getTotalSubscriptions($filter_data);
        
        $results = $this->model_extension_ventocart_report_subscription->getSubscriptions($filter_data);
        ...
        $data['pagination'] = $this->load->controller('common/pagination', [
            ...
            'page'  => $page,
            'limit' => $this->config->get('config_pagination'),
            'url'   => $this->url->link('extension/ventocart/report/subscription', 'user_token=' . $this->session->data['user_token'] . '&code=subscription' . $url . '&page={page}')
        ]);
        ...
        return $this->load->view('extension/ventocart/report/subscription_list', $data);
    }
}
