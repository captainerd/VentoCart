...
class Customer extends \Ventocart\System\Engine\Controller {
	...
	public function index(): void {
		$this->load->language('extension/ventocart/report/customer');
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/ventocart/report/customer', 'user_token=' . $this->session->data['user_token'])
		];

		$data['save'] = $this->url->link('extension/ventocart/report/customer.save', 'user_token=' . $this->session->data['user_token']);
		...
		$this->response->setOutput($this->load->view('extension/ventocart/report/customer_form', $data));
	}
	...
	public function save(): void {
		...
		if (!$this->user->hasPermission('modify', 'extension/ventocart/report/customer')) {
	...
	public function report(): void {
		...
		$this->response->setOutput($this->load->view('extension/ventocart/report/customer', $data));
	}
	...
	public function getReport(): string {
		...
		$customer_total = $this->model_extension_ventocart_report_customer->getTotalCustomers($filter_data);

		$results = $this->model_extension_ventocart_report_customer->getCustomers($filter_data);
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'url'   => $this->url->link('extension/ventocart/report/customer.report', 'user_token=' . $this->session->data['user_token'] . '&code=customer' . $url . '&page={page}')
		]);
		...
		return $this->load->view('extension/ventocart/report/customer_list', $data);
	}
}
