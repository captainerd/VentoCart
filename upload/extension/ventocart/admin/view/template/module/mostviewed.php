    ...
    <div class="card">
      ...
      <div class="card-body">
        <form id="form-module" action="<?= $this->e($save) ?>" method="post" data-oc-toggle="ajax">
          ...
          <div class="row mb-3">
            <label for="input-timeframe" class="col-sm-2 col-form-label"><?= $this->e($entry_timeframe) ?></label>
            <div class="col-sm-4">
              <select name="timeframe" id="input-timeframe" class="form-select">
                <option value="week" <?= $this->e($timeframe == 'week' ? 'selected' : '') ?>>Week</option>
                <option value="month" <?= $this->e($timeframe == 'month' ? 'selected' : '') ?>>Month</option>
                <option value="year" <?= $this->e($timeframe == 'year' ? 'selected' : '') ?>>Year</option>
                <option value="year" <?= $this->e($timeframe == 'alltime' ? 'selected' : '') ?>>All Time</option>
