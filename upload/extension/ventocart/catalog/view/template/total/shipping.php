<div class="accordion-item">
    <h2 class="accordion-header"><button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
            data-bs-target="#collapse-shipping"><?= $this->e($heading_title) ?></button></h2>
            ...
            <form id="form-quote">
                ...
                <div class="row mb-3 required">
                    <label for="input-postcode"
                        class="col-md-4 col-form-label"><?= $this->e($entry_postcode) ?></label>
                    <div class="col-md-8">
                ...
                <div class="text-end">
                    <button type="submit" id="button-quote"
                        class="btn btn-primary"><?= $this->e($button_quote) ?></button>
                </div>
            </form>
        </div>
    </div>
...
<script><!--
  $('#form-quote').on('submit', function (e) {
      ...
      $.ajax({
          url: 'index.php?route=extension/ventocart/total/shipping.quote&language=<?= $this->e($language) ?>',
    type: 'post',
    ...
    $(document).on('submit', '#form-shipping', function (e) {
        ...
        $.ajax({
            url: 'index.php?route=extension/ventocart/total/shipping.save&language=<?= $this->e($language) ?>',
            type: 'post',
