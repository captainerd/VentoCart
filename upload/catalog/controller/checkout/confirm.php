...
class Confirm extends \Opencart\System\Engine\Controller {
	public function index(): string {
		...
		$filteredData = array_filter($totals, function ($item) {
			return in_array($item['code'], ['total', 'shipping', 'coupon']);
		});
		foreach ($filteredData as $total) {
			$data['totals'][] = [
				'code' => $total['code'],
				'title' => $total['title'],
