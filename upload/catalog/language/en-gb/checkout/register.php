...
$_['entry_match']             = 'Ship to different address';
$_['entry_invoice']             = 'Issue company invoice';

//database id of country or inspect html <select><option>country 
//to retrieve the id.
$_['country_company_fields'] =   array(
    84 => 'VIN (AFM), Industry, Tax Office (DOY)', //greece
    33 => 'VAT number', //Bulgaria
    223 => 'TIN', // United Kingdom
    224 => 'TIN', // United States (USA)
    // Add more country IDs and their relevant fields here
);
...
$_['error_phone']      = 'Digits only. Include the country code (e.g., +33 for France)';
