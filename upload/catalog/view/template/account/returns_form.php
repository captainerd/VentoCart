      ...
      <form id="form-return" action="<?= $save ?>" method="post" data-oc-toggle="ajax">
        <fieldset>
          ...
          <div class="row mb-3 required">
            ...
            <div class="col-sm-10">
              <input type="text" name="email" value="<?= $this->e($email) ?>"
          ...
          <div class="row mb-3 required">
            ...
            <div class="col-sm-10">
              <input type="text" name="telephone" value="<?= $this->e($telephone) ?>"
          ...
          <div class="row mb-3 required">
            ...
            <div class="col-sm-10">
              <input type="text" name="order_id" value="<?= $this->e($order_id) ?>"
                placeholder="<?= $this->e($entry_order_id) ?>" id="input-order-id" class="form-control">
              <div id="error-order-id" class="invalid-feedback"></div>
            </div>
          </div>
          <div class="row mb-3">
            <label for="input-date-ordered"
              class="col-sm-2 col-form-label"><?= $this->e($entry_date_ordered) ?></label>
            <div class="col-sm-10 col-md-4">
              <div class="input-group">
                <input type="text" name="date_ordered" value="<?= $this->e($date_ordered) ?>"
                  placeholder="<?= $this->e($entry_date_ordered) ?>" id="input-date-ordered"
        ...
        <fieldset>
          ...
          <div class="row mb-3 required">
            ...
            <div class="col-sm-10">
              <input type="text" name="product" value="<?= $this->e($product) ?>"
                placeholder="<?= $this->e($entry_product) ?>" id="input-product" class="form-control"> <input
                type="hidden" name="product_id" value="<?= $this->e($product_id) ?>" />
              <div id="error-product" class="invalid-feedback"></div>
            </div>
          </div>
          <div class="row mb-3 required">
            <label for="input-model" class="col-sm-2 col-form-label"><?= $this->e($entry_sku) ?></label>
            <div class="col-sm-10">
              <input type="text" name="model" value="<?= $this->e($sku) ?>" placeholder="<?= $this->e($entry_sku) ?>"
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" name="quantity" value="1" placeholder="<?= $this->e($entry_quantity) ?>"
              ...
              <div id="input-reason">
                <?php foreach ($return_reasons as $return_reason): ?>
                  <div class="form-check">
                    <input type="radio" name="return_reason_id"
                      value="<?= $this->e($return_reason['return_reason_id']) ?>"
                      id="input-return-reason-<?= $this->e($return_reason['return_reason_id']) ?>"
                      class="form-check-input"> <label
                      for="input-return-reason-<?= $this->e($return_reason['return_reason_id']) ?>"
                      class="form-check-label"><?= $this->e($return_reason['name']) ?></label>
                  </div>
                <?php endforeach; ?>
              </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <textarea name="comment" rows="5" placeholder="<?= $this->e($entry_fault_detail) ?>" id="input-comment"
