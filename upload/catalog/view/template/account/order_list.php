          ...
          <table class="table table-bordered table-hover">
            <thead>
              <tr>
                ...
                <td class="text-end"><?= $this->e($column_product ) ?></td>
            ...
            <tbody>
              <?php foreach ($orders as $order): ?>
                <tr>
                  <td class="text-end">#<?= $this->e($order['order_id']) ?></td>
                  <td class="text-start"><?= $this->e($order['name']) ?></td>
                  <td class="text-end"><?= $this->e($order['products']) ?></td>
                  ...
                  <td class="text-end"><a href="<?= $order['view'] ?>" data-bs-toggle="tooltip" title="<?= $this->e($button_view ) ?>" class="btn btn-info"><i class="fa-solid fa-eye"></i></a></td>
                </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
