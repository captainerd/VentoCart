    ...
    <div id="content" class="col"><?=  $content_top  ?>
      ...
      <form>
        <div class="row mb-3">
          ...
          <div class="col-md-10">
            <textarea cols="40" rows="5" placeholder="<?= $this->e($entry_code ) ?>" id="input-code" class="form-control"><?= $this->e($code ) ?></textarea>
          </div>
        </div>
        <div class="row mb-3">
          <label for="input-generator" class="col-md-2 col-form-label"><?= $this->e($entry_generator ) ?></label>
          <div class="col-md-10">
            <input type="text" name="product" value="" placeholder="<?= $this->e($entry_generator ) ?>" id="input-generator" data-oc-target="autocomplete-generator" class="form-control" autocomplete="off"/>
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-10">
            <textarea name="link" cols="40" rows="5" placeholder="<?= $this->e($entry_link ) ?>" id="input-link" class="form-control"></textarea>
          </div>
        </div>
      </form>
