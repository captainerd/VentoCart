            ...
            <div class="col">
                <div class="card shadow">
                    <div class="card-header">
                        <strong><?= $this->e($column_order_id) ?>: <?= $this->e($download['order_id']) ?></strong>
                    </div>
                    <div class="card-body">
                        <div class="row">
                    ...
                    <div class="card-footer">
                        <a href="<?= $download['href'] ?>" data-bs-toggle="tooltip" title="<?= $this->e($button_download) ?>" class="btn btn-primary">
